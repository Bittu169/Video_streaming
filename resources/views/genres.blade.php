		...
		<div class="w3l-medile-movies-grids">
				      ...
				      <div class="movie-browse-agile">
						 ...
						 <div class="browse-agile-w3ls general-w3ls">
								...
								<div class="tittle-head">
									<h4 class="latest-text" style="color: #fff;">Family Movies </h4>
									<div class="container">
				...
				<!--body wrapper start-->
					<div class="review-slider">
						 <h4 class="latest-text" style="color: #fff;">Movie Reviews</h4>
						       <div class="container">
				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1" style="background:#fff; width:180px; height: 230px;">
							<a href="{{route('single',['id'=>$g->id])}}" class="hvr-shutter-out-horizontal" style="height: 150px; "><img style="width:130px; height:150px; padding-left: 15px; padding-top: 5px; " src="{{url('/assets/movie_img')}}/{{$g->image}}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="{{route('single',['id'=>$g->id])}}">{{$g->mname}}</a></h6>							
								</div>
