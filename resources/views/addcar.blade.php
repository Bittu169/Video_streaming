            ...
            <div id="content" style="background: #53c4b5;">
                ...
                <div class="container-fluid col-md-9" style=" padding: 10px; margin: auto;">
                    ...
                    <form action="{{route('insertcar')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <br><br>
                        <h1 style="color:black;display:flex; align-items:center; justify-content:center;">Fill Carousel Details</h1><hr>
                        <h3 style="color:black;">Movie Name</h3>
                         <input type="text" name="name" class="form-control" placeholder="Enter movie name...." required><br>    
                         <h3 style="color:black;">Movie Type</h3>
                         <input type="text" name="mtype" class="form-control" placeholder="Enter movie type....">                
